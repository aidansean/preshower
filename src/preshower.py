...
vars['E'           ] = var_object('E'           , 100, 0, 2500, 'E(e)'                  , 'electrons', 'GeV')
vars['E_w'         ] = var_object('E_w'         , 100, 0, 2500, 'E(e) <weighted>'       , 'electrons', 'GeV')
vars['E_cut'       ] = var_object('E_cut'       , 100, 0, 2500, 'E(e) (PSE>5 GeV)'      , 'electrons', 'GeV')
